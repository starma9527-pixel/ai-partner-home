...
const MODEL_CONFIG = {
  'qwen35plus': { id: 'qwen-plus', maxTokens: 2000, displayName: 'Qwen-Plus' },
  'qwenmax': { id: 'qwen-max', maxTokens: 2000, displayName: 'Qwen-Max' },
  'kimi': { id: 'kimi-k2.5', maxTokens: 2000, displayName: 'Kimi-K2.5' },
  'minimax': { id: 'MiniMax-M2.5', maxTokens: 2000, displayName: 'MiniMax-M2.5' }
};
